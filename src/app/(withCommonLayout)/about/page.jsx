...
import { Heart, ShieldCheck, Star, PhoneCall } from "lucide-react";
...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-[#FF7A59] to-[#e66a4d] dark:from-[#FF9A7A] dark:to-[#FF7A59] py-24 md:py-32 text-white overflow-hidden">
        <div className="absolute inset-0 opacity-10 bg-[url('/pattern-family.svg')] bg-repeat"></div>
      ...
      <section className="py-16 md:py-24 bg-gray-100 dark:bg-gray-950">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {/* Card 1 */}
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-md hover:shadow-xl transition-all duration-300 text-center border border-gray-200 dark:border-gray-700">
              <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-[#FF7A59]/10 dark:bg-[#FF9A7A]/20 flex items-center justify-center">
                <ShieldCheck className="w-10 h-10 text-[#FF7A59] dark:text-[#FF9A7A]" />
              </div>
            ...
            {/* Card 2 */}
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-md hover:shadow-xl transition-all duration-300 text-center border border-gray-200 dark:border-gray-700">
              <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-[#34C759]/10 dark:bg-[#34C759]/20 flex items-center justify-center">
                <Star className="w-10 h-10 text-[#34C759] dark:text-[#4ADE80]" />
              </div>
              <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">
                Top Rated
              </h3>
            ...
            {/* Card 3 */}
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-md hover:shadow-xl transition-all duration-300 text-center border border-gray-200 dark:border-gray-700">
              <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-[#4A90E2]/10 dark:bg-[#60A5FA]/20 flex items-center justify-center">
                <PhoneCall className="w-10 h-10 text-[#4A90E2] dark:text-[#60A5FA]" />
              </div>
              <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">
                24/7 Support
              </h3>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-md hover:shadow-xl transition-all duration-300 text-center border border-gray-200 dark:border-gray-700">
              <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-[#FF7A59]/10 dark:bg-[#FF9A7A]/20 flex items-center justify-center">
                <Heart className="w-10 h-10 text-[#FF7A59] dark:text-[#FF9A7A]" />
              </div>
              <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">
                Family First
              </h3>
      ...
      {/* CTA at bottom */}
      <section className="py-20 md:py-28 bg-gradient-to-r from-[#FF7A59] to-[#e66a4d] dark:from-[#FF9A7A] dark:to-[#FF7A59] text-white text-center">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <Link
            href="/signup"
            className="
              inline-block bg-white dark:bg-gray-900 
              text-[#FF7A59] dark:text-[#FF9A7A] 
              font-bold text-xl px-12 py-6 
